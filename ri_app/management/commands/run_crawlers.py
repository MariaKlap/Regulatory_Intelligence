...
class Command(BaseCommand):
            ...
            for _, row in df.iterrows():
                ...
                try:
                    records.append(RegulatoryData(
                        ...
                        Drug_names=self.clean_names(str(row.get('Drug_names', '')) or None),
    ...
    def clean_names(self, drug_name):
        """Remove unwanted characters ([], '', 'nan', +, etc.) from drug names."""
        ...
        for char in unwanted_chars:
            drug_name = drug_name.replace(char, "")
        
        # Strip whitespace and return (or None if empty after cleaning)
